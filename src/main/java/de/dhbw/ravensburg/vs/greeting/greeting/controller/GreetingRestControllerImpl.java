...
public class GreetingRestControllerImpl implements GreetingRestController {
    ...
    public String getGreeting(@RequestParam(value = "lang",defaultValue = "en") @Parameter(description = "The prefered language for which the wellcome message will be adopted.") String lang){
